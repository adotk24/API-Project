...
//edit booking
router.put('/:bookingId/edit', requireAuth, async (req, res, next) => {
    ...
    edittedBooking.update({ startDate, endDate })
    return res.json(edittedBooking)

})

//delete a booking
router.delete('/:bookingId/delete', requireAuth, async (req, res, next) => {
